if _G.RunScriptRequest then
	game:GetService("Players").LocalPlayer:Kick("Run Script Only 1 Time")
else
	_G.RunScriptRequest = true
end

local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Green> Loading <Crazzy Hub> <Color=/>"):Display()
Notification.new("<Color=Red> Tái chế by <tungsuccac> <Color=/>"):Display()
...
game.StarterGui:SetCore("SendNotification", {
	...
	game.StarterGui:SetCore("SendNotification", {
	Title = "Tái chế sara hub trash";
	Text = "https://discord.gg/TJuFphgp";
	Duration = "100000000000000000";
	})
